...
namespace jarvis2UI.Data_Model
{
    public class SwarmProfileDataset
    {
        ...
        private void GenerateBaseData()
        {
            ...
            Profiles.Add(new SwarmProfile { EmpNumber = 104600, Name = "Jenitta Rexlin Antony", EmailId = "rexlin.jenitta@cg.com", ContactNumber = 9834534643, TeamName = "Dedup", Skills = new List<string> { "datapath", "controlpath", "devtest" }, ExperienceInTeam = 5, SwarmGroupName = "backlog_swarm", Age = 36, IsMarried = true, NumberOfChildren = 1, LeavesEntitled = 14 });
