...
{
    public static class SwarmProfileDataset
    {
        const String DATASETFILENAME = "SwarmProfilesDataset.xml";
        private static List<SwarmProfile> profiles;

        public static List<SwarmProfile> Profiles
        {
            get { return profiles; }
            set
            {
        ...
        private static void GenerateBaseData()
        {
            ...
            Profiles.Add(new SwarmProfile { EmpNumber = 563, Name = "Patel Dipak Rameshbhai", EmailId = "dipak.patel@cg.com", ContactNumber = 9724232355, TeamName = "NAS", Skills = new List<string> { "datapath", "controlpath", "devtest" }, ExperienceInTeam = 5, SwarmGroupName = "backlog_swarm", Age = 38, IsMarried = true, NumberOfChildren = 1, LeavesEntitled = 16 });
            ...
            Profiles.Add(new SwarmProfile { EmpNumber = 665, Name = "Verma Arun Amarnath", EmailId = "arun.verma@cg.com", ContactNumber = 9623423455, TeamName = "NAS", Skills = new List<string> { "datapath", "controlpath", "devtest" }, ExperienceInTeam = 5, SwarmGroupName = "active_swarm", Age = 37, IsMarried = true, NumberOfChildren = 1, LeavesEntitled = 10 });
            ...
            Profiles.Add(new SwarmProfile { EmpNumber = 273, Name = "Salvi Priyanka Pandurang", EmailId = "priyanka.salvi@cg.com", ContactNumber = 8034534623, TeamName = "Dedup", Skills = new List<string> { "rpc", "tools", "UI" }, ExperienceInTeam = 2, SwarmGroupName = "backlog_swarm", Age = 33, IsMarried = false, NumberOfChildren = 2, LeavesEntitled = 12 });
            Profiles.Add(new SwarmProfile { EmpNumber = 843, Name = "Bhatnagar Anshu Diwakar", EmailId = "anshu.bhatnagar@cg.com", ContactNumber = 9934534623, TeamName = "Dedup", Skills = new List<string> { "datapath", "controlpath", "devtest" }, ExperienceInTeam = 6, SwarmGroupName = "active_swarm", Age = 42, IsMarried = true, NumberOfChildren = 0, LeavesEntitled = 11 });
            Profiles.Add(new SwarmProfile { EmpNumber = 334, Name = "Jenitta Rexlin Antony", EmailId = "rexlin.jenitta@cg.com", ContactNumber = 9834534643, TeamName = "Dedup", Skills = new List<string> { "datapath", "controlpath", "devtest" }, ExperienceInTeam = 5, SwarmGroupName = "backlog_swarm", Age = 36, IsMarried = true, NumberOfChildren = 1, LeavesEntitled = 14 });
            Profiles.Add(new SwarmProfile { EmpNumber = 652, Name = "Bhatnagar Aayushi ", EmailId = "bhatnagar.bhatnagar@cg.com", ContactNumber = 9743534246, TeamName = "Dedup", Skills = new List<string> { "datapath", "controlpath", "devtest" }, ExperienceInTeam = 6, SwarmGroupName = "active_swarm", Age = 41, IsMarried = true, NumberOfChildren = 1, LeavesEntitled = 10 });
        }
