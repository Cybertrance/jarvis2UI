<%@ Page Title="Log Analytics" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="analysis.aspx.cs" Inherits="jarvis2UI.analysis" %>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="accordion" id="accordion1" role="tablist" aria-multiselectable="true">
                                                ...
                                                <div class="panel-body">
                                                    <div class="x_content">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2 col-sm-12 col-xs-12" style="position: relative; top: 100px">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <form class="form-vertical">
                                                        <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                                            <label id ="processedtextheader" style="display: none">Recommendation</label>
                                                            <textarea class="form-control" rows="5" id="processedtext" style="display: none" readonly="readonly"></textarea>
                                                        </div>
                                                        <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                                            <label id="imgprocessedimageheader" style="display: none">Recommendation Image</label>
                                                            <img class="form-control" src="" style="display: none; height: 500px; width:500px" id="imgprocessedimage" />
                                                        </div>
                                        ...
                                        <div class="panel">
                                            <a class="panel-heading collapsed" role="tab" id="headingTwo2" data-toggle="collapse" data-parent="#accordion1" href="#collapseTwo2" aria-expanded="false" aria-controls="collapseTwo">
